 ...
 *                           Select this timer for measurement polling interval for 1 second.
 * %ADC_MEAS_TIMER_SELECT2 - Select this timer if the client is batt_therm.
 *                           Select this timer for 500ms measurement interval.
 * %ADC_MEAS_TIMER_SELECT3 - Select this timer for 5 second interval.
 *      The timer is added only for completion. It is
